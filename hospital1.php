...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="http://www.kmchcop.ac.in/images/banner/institutions/arts.jpg" alt="Image">
...
<div class="container text-center">    
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="well">
        <h4>TRUST</h4><br>
       <p>The Kovai Medical Center Research and Educational Trust was established in the year 1990 with the goal of rendering quality education and training to the people of India and the world.

The Trust was envisioned by our trustees with the single-minded objective of imparting education that is truly a class apart. Today, that vision has culminated into a world-class organization of repute, rendering education to students from diverse cross-cultural backgrounds. Having grown from strength to strength, presently Trust is running 10 Educational Institutions in the field of Health Sciences, Arts & Science, Engineering & Technology, Teacher Education and a CBSE affiliated school..</p>
      </div>
  </div>
</div><br>
